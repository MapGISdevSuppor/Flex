...
import utilEvent.SuperPanelEvent;
 ...
 *
 *  @eventType myEvent.SuperPanelEvent.MAXIMIZE
 */
[Event(name="maximize", type="utilEvent.SuperPanelEvent")]

/**
 *  Dispatched when the panel is minimized.
 *
 *  @eventType myEvent.SuperPanelEvent.MINIMIZE
 */
[Event(name="minimize", type="utilEvent.SuperPanelEvent")]

/**
 *  Dispatched when the panel is restored from either a minimized or 
 *  maximized state.
 *
 *  @eventType myEvent.SuperPanelEvent.RESTORE
 */
[Event(name="restore", type="utilEvent.SuperPanelEvent")]
 ...
 *
 *  @eventType myEvent.SuperPanelEvent.DRAG_START
 */
[Event(name="dragStart", type="utilEvent.SuperPanelEvent")]

/**
 *  Dispatched while the panel is being dragged.
 *
 *  @eventType myEvent.SuperPanelEvent.DRAG
 */
[Event(name="drag", type="utilEvent.SuperPanelEvent")]

/**
 *  Dispatched when the panel stops being dragged.
 *
 *  @eventType myEvent.SuperPanelEvent.DRAG_END
 */
[Event(name="dragEnd", type="utilEvent.SuperPanelEvent")]

/**
 *  Dispatched when the resize handle is pressed.
 *
 *  @eventType myEvent.SuperPanelEvent.RESIZE_START
 */
[Event(name="resizeStart", type="utilEvent.SuperPanelEvent")]

/**
 *  Dispatched when the mouse is released from the resize handle.
 *
 *  @eventType myEvent.SuperPanelEvent.RESIZE_END
 */
[Event(name="resizeEnd", type="utilEvent.SuperPanelEvent")]
...
public class SuperPanel extends Panel
{
     ...
     *  @private
     */
    private var _allowMaximize:Boolean = true;
...
//		titleBar.addEventListener(MouseEvent.CLICK,titleBar_mouseClickHandler);
	...
	//标题栏单击事件
	public function titleBar_mouseClickHandler(e:MouseEvent):void
	{
		toggleMinimize();
	}
    /**
     ...
     *  @private
     */
    public function titleBar_doubleClickHandler(event:MouseEvent):void
    {
    	if (_allowMaximize)
    		toggleMaximize();
	...
	private function titleBar_mouseOutHandler(event:*):void
	{
...
//		this.x=this.parent.width-this.width-10;
//		this.y=90*num;
...
//			flag=false;
    	...
    	else if(!isMinimized||this.height>titleBar.height)
		{	
    		minimize();
//			if(num<4)
//			num++;
//			flag=true;
    ...
    protected function updateRestoreRect():void
    {
    	...
    	else if (minimizeRestoreRect != null)
    	{
    		...
    		minimizeRestoreRect.x = 300;
    		minimizeRestoreRect.y = 300;
			
    	}
    	else
    	{
    		minimizeRestoreRect = new Rectangle(300, 
    											300, 
