	...
	public class NewChartColumn extends Group
	{
		...
		public function initDraw():void{  
			...
			if(ui==null){
				...
				//this.imsmap.addEventListener(IMSMapEvent.MAP_CHANGE,onMapZoomHanle);
		...
		public function clearChart():void{
			if(this.imsmap!=null){
				if(this.ui!=null){
					...
					//this.imsmap.removeEventListener(IMSMapEvent.MAP_CHANGE,onMapZoomHanle);
